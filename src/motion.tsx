...
import { withHooks } from "@firere/roact-hooked";
...
function withAnimation<T extends keyof JSX.IntrinsicElements>(
	elementType: T,
): (props: JSX.IntrinsicElements[T] & WithAnimationProps<GuiObject & Record<string, unknown>>) => Roact.Element {
	return withHooks((props: JSX.IntrinsicElements[T] & WithAnimationProps<GuiObject & Record<string, unknown>>) => {
